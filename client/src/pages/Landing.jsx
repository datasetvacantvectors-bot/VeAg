    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-300 via-orange-200 to-yellow-100 overflow-hidden no-blur-theme">
      ...
      >
                  ...
                  {languages.map((lang, index) => (
                    <motion.button
                      ...
                      className={`w-full px-4 py-3 flex items-center gap-3 hover:bg-gradient-to-r hover:from-orange-100/50 hover:to-yellow-100/50 transition-all duration-300 ${
                        language === lang.code
                          ? "bg-gradient-to-r from-orange-100/70 to-yellow-100/70"
                          : ""
                      }`}
                    >
        ...
        <div className="relative z-30 flex flex-col items-center justify-center text-center px-4">
          ...
          >
            <div
              className="absolute inset-0 rounded-full bg-gradient-to-br from-orange-400 via-orange-500 to-red-500 blur-2xl opacity-60 animate-pulse"
              style={{
                width: "160px",
                height: "160px",
                marginLeft: "auto",
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              {t.landing.features?.subtitle ||
                "Advanced technology for your crops"}
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                title: "AI Analysis",
                desc: "Advanced disease detection",
              },
              {
                key: "feature2",
                gradient: "from-green-400 to-teal-500",
                title: "Instant Results",
                desc: "Get results in minutes",
              },
              {
                key: "feature3",
                gradient: "from-teal-400 to-cyan-500",
                title: "Multiple Crops",
                desc: "Support for various crops",
              },
            ].map((feature, index) => {
              return (
                <motion.div
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              {t.landing.howItWorks?.subtitle ||
                "Simple process to protect your crops"}
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            ...
            <svg
              className="hidden lg:block absolute top-24 left-0 w-full h-2"
              style={{ zIndex: 0 }}
            >
              <motion.path
          ...
          <div className="space-y-4">
            {["q1", "q2", "q3", "q4", "q5", "q6"].map((q, index) => (
              ...
              >
                ...
                <div
                  className={`absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-emerald-400 via-green-400 to-teal-400 transform origin-left transition-transform ${
            ...
            {[
              {
                ...
                desc:
                  t.landing.contact?.general?.description ||
              ...
              },
              {
                ...
                desc:
                  t.landing.contact?.payment?.description ||
                  "For billing queries",
                delay: 0.2,
              },
            ].map((contact, index) => {
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  onClick={() => navigate("/return-refund-cancellation")}
                  className="text-gray-400 hover:text-white transition-colors text-left"
                >
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>
              © {new Date().getFullYear()} VeAg.{" "}
              {t.landing.footer?.rights || "All rights reserved"}
            </p>
            <p className="text-sm text-gray-500 mt-2">Version 5.5.5</p>
          </div>
        </div>
      </footer>
    </div>
