    ...
    <div className="min-h-screen bg-gradient-to-b from-orange-300 via-orange-200 to-yellow-100 relative overflow-hidden">
      ...
      {showSupport && (
        ...
        >
          ...
          <p className="text-white/90 mb-4">{t.registerCase.supportText}</p>
          <a
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
          ...
          <div className="bg-green-600/80 backdrop-blur-xl text-white rounded-lg p-4 mb-6 flex items-center justify-between shadow-lg border border-green-400/50">
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold flex items-center gap-2">
                ...
                {t.registerCase.activeSubscription}: {daysRemaining}{" "}
                {t.registerCase.daysRemaining}
              </span>
            </div>
          </div>
        )}
        ...
        <div className="bg-black/30 backdrop-blur-2xl border border-white/40 rounded-2xl shadow-2xl p-8">
          <h2 className="text-3xl font-bold text-white mb-6">
            {t.registerCase.title}
          </h2>

          {/* Crop Selection Dropdown */}
          <div className="mb-8">
            <label className="block text-white font-semibold mb-3 text-lg">
              {t.registerCase.selectCrop}{" "}
                ...
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="w-full overflow-x-auto flex space-x-2 py-2">
                    {uploadedImages.length > 0 ? (
                      uploadedImages.map((src, index) => (
                        <div
                          key={index}
                          className="relative flex-shrink-0 w-20 h-20 border-2 border-white/40 rounded-lg bg-white/10 backdrop-blur-xl flex items-center justify-center group"
                        >
                          <img
                            src={src}
                            alt={`preview ${index}`}
                      ...
                      <div className="flex justify-center gap-2 w-full">
                        {Array(3)
                          ...
                          .map((_, index) => (
                            <div
                              key={index}
                              className="w-20 h-20 border-2 border-white/30 rounded-lg bg-white/10 backdrop-blur-xl flex items-center justify-center"
                            >
                              <span className="text-white/50 text-xs">
                                {t.registerCase.empty}
                              </span>
                            </div>
                          ))}
                      </div>
                  ...
                  >
                    ...
                    <span className="mt-2 text-lg font-semibold">
                      {t.registerCase.addPhotos}
                    </span>
                    <span className="text-sm text-white/70 mt-1">
                      {t.registerCase.maxImages}
                    </span>
                  </button>
                  <input
                    ref={fileInputRef}
            ...
            >
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <h2 className="text-3xl font-bold text-white mt-4 mb-2">
                  {t.registerCase.successTitle}
                </h2>
                <p className="text-lg text-white/70">
                  {t.registerCase.successMessage}
                </p>
              </div>
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold text-white">
                      {createdCase.cropName
                        ? createdCase.cropName.charAt(0).toUpperCase() +
                          createdCase.cropName.slice(1)
                        : ""}
                    </p>
                  </div>
              ...
              <button
                onClick={() =>
                  navigate(`/case/${createdCase.caseId}`, { replace: true })
                }
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <h2 className="text-2xl font-bold text-white mb-2">
                  {t.registerCase.submissionFailed}
                </h2>
